              ...
              <div className="relative">
                ...
                <div className="relative w-4/5 mx-auto">
                  <motion.input
                    ...
                    className="w-full pl-6 pr-12 py-2.5 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300 placeholder:text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-center"
